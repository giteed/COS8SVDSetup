...
Основным достоинством которой является скачивание этих файлов 
через сеть TOR. # dtfex и # dtfex_help
...
с файлоо-обменников, с которых вы хотите получилть файлы. 
...
которые поддерживают данныый скрипт, по всей видимости \"их начинка\" идентичная.
