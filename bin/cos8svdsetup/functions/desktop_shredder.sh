...
function mvds() {
    ...
    function _mvds() {
      ...
      # shuf - это команда, которая случайным образом перемешивает и выводит строки.
      # -i 100-999 - это опция команды shuf, которая указывает диапазон чисел, в данном случае от 100 до 999.
      # -n 1 - это опция команды shuf, которая указывает, сколько случайных чисел нужно сгенерировать, в данном случае 1 число.
