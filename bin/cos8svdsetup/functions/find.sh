...
sis5() {
     # Функция справки
     function help_sis5() {
       echo -e "\n Выполнение поиска текста в теле скриптов, с выводом 5 строк. По умолчанию расширение файлов *.sh, а путь \"/\"\n Поиском можно искать текст в обычных текстовых файлах указав тип файла в команде.\n "
       ...
       echo -e "                  sis5 - Команда которая делает тоже самое, но не выводит текст из файлов "
