...
# '*' | '.'| h | -h | --help | help | '')
function _help() {
	 ttb=$(echo -e "\n | wis -a [имя_файла] или wis -a [имя_файла]\n | или wis -a [имя_функции]\n | Совмещает в себе для \n | удобства набор следующих программ и утилит: ") && lang=nix && bpn_p_lang ;
