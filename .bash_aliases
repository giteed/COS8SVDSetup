...
alias lip='lip-f'
alias who='echo -e '' &&  who -H | bat  --paging=never -l c -p && wport ssh && cat /etc/passwd | rg -v "nologin" | rg -v shutdown | rg -v sync | rg -v false | rg -v halt | bat -l passwd -p && echo -e "\n $( red_U0023 ) bat /etc/passwd && (cat /etc/passwd | rg -v "nologin" | rg -v shutdown | rg -v sync | rg -v false | rg -v halt | bat -l passwd -p)\n" '
